...
$(document).ready(function () {
    var colaborador_nivel = void 0;
    var modulo_cadastros = void 0,
        modulo_rh = void 0,
        modulo_financeiro = void 0,
        modulo_comercial = void 0,
        modulo_engenharia = void 0,
        modulo_administrativo = void 0,
        link_avatar = void 0,
        user_name = void 0;
    /**
    ...
    if (window.location.href !== "http://app.tecman.com/login") {
        var $sair = document.getElementById("sair_sistema");
        if ($sair) {
