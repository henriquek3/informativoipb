-- create database lara_informativoipb charset utf8mb4 collate utf8mb4_unicode_ci;
...
CREATE TABLE `relatorios_ministros` (
  ...
  `campos_igrejas`                   longtext,
  `campos_congregacoes`              longtext,
  `pregacoes`                        int,
...
CREATE TABLE `oficiais_vencimentos` (
  `id`                    int NOT NULL AUTO_INCREMENT,
  `id_presbitero`         int NOT NULL,
...
ALTER TABLE `relatorios_ministros`
  ADD CONSTRAINT `relatorios_ministros_fk1` FOREIGN KEY (`id_igreja`) REFERENCES `igrejas` (`id`);

ALTER TABLE `relatorios_ministros`
  ADD CONSTRAINT `relatorios_ministros_fk2` FOREIGN KEY (`usuario_inclusao`) REFERENCES `usuarios` (`id`);

ALTER TABLE `relatorios_ministros`
  ADD CONSTRAINT `relatorios_ministros_fk3` FOREIGN KEY (`usuario_alteracao`) REFERENCES `usuarios` (`id`);

ALTER TABLE `relatorios_conselhos`
  ADD CONSTRAINT `relatorios_conselhos_fk0` FOREIGN KEY (`id_igreja`) REFERENCES `igrejas` (`id`);

ALTER TABLE `relatorios_conselhos`
  ADD CONSTRAINT `relatorios_conselhos_fk1` FOREIGN KEY (`sa_id_oficiais_vencimento`) REFERENCES `oficiais_vencimentos` (`id`);
...
ALTER TABLE `oficiais_vencimentos`
  ADD CONSTRAINT `oficiais_vencimentos_fk0` FOREIGN KEY (`id_presbitero`) REFERENCES `presbiteros` (`id`);

ALTER TABLE `oficiais_vencimentos`
  ADD CONSTRAINT `oficiais_vencimentos_fk1` FOREIGN KEY (`id_relatorio_conselho`) REFERENCES `relatorios_conselhos` (`id`);
...
ALTER TABLE `reunioes_sinodos_relatorios`
  ADD CONSTRAINT `reunioes_sinodos_relatorios_fk2` FOREIGN KEY (`id_relatorio_conselho`) REFERENCES `relatorios_conselhos` (`id`);

ALTER TABLE `reunioes_sinodos_relatorios`
  ADD CONSTRAINT `reunioes_sinodos_relatorios_fk3` FOREIGN KEY (`id_relatorio_estatistica`) REFERENCES `relatorios_estatisticas` (`id`);

ALTER TABLE `reunioes_sinodos_relatorios`
  ADD CONSTRAINT `reunioes_sinodos_relatorios_fk4` FOREIGN KEY (`	id_relatorio_ministro`) REFERENCES `relatorios_ministros` (`id`);
