            ...
            <div class="ui bottom attached tab segment" data-tab="second">
                <div class="ui form segment">
                    <form id="formUsuarios" name="formUsuarios">@csrf
                        <div class="fields">
                            <div class="eight wide field"><label>Sínodo</label> <select class="ui fluid search dropdown"
                                                                                        name="id_sinodo">
                                    <option></option>
                                </select></div>
                            <div class="eight wide field" id="div_presbiterio"><label>Presbitério</label> <select
                                        class="ui fluid search dropdown" name="id_presbiterio"></select>
                                <div class="ui active inline small loader" style="display:none"
                                     id="loader_presbiterio"></div>
                            </div>
                        </div>
                        <div class="fields">
                            <div class="eight wide field" id="div_igreja"><label>Igreja</label> <select
                                        class="ui fluid search dropdown" name="id_igreja"></select>
                                <div class="ui active inline small loader" style="display:none"
                                     id="loader_igreja"></div>
                            </div>
                            <div class="eight wide field" id="div_presbitero"><label>Presbítero</label> <select
                                        class="ui fluid search dropdown" name="id_presbitero"></select>
                                <div class="ui active inline small loader" style="display:none"
                                     id="loader_presbitero"></div>
                            </div>
                        </div>
                        <div class="fields">
                            <div class="seven wide field required"><label>Nome</label> <input type="text" name="nome">
                            </div>
                            <div class="six wide field required"><label>E-Mail</label> <input type="email" name="email">
                            </div>
                            <div class="three wide field required"><label>CPF</label> <input type="text" name="cpf">
                            </div>
                        </div>
                        <div class="fields">
                            <div class="four wide field"><label>Status do Usuário</label> <select
                                        class="ui fluid search dropdown" name="status">
                                    <option></option>
                                    <option value="1">Ativo</option>
                                    <option value="0">Inativo</option>
                                </select></div>
                            <div class="four wide field"><label>Nível</label> <select class="ui fluid search dropdown"
                                                                                      name="nivel">
                                    <option></option>
                                    <option value="0">Comum</option>
                                    <option value="1">Superior</option>
                                </select></div>
                            <div class="four wide field"><label>Perfil</label> <select class="ui fluid search dropdown"
                                                                                       name="perfil">
                                    <option></option>
                        ...
                        <div class="fields">
                            <div class="sixteen wide field"><label>Observações</label> <textarea rows="3"
                        ...
                        <div style="text-align: center">
                            ...
                            <button class="ui yellow labeled icon button" type="button"><i class="redo icon"></i>Resetar
                                senha
                            </button>
                    ...
                    <form id="formDelete" name="formDelete" method="post">@csrf @method("delete")</form>
                </div>
            </div>
        </div>
    </div>
