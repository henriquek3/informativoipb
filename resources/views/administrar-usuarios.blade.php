        ...
        <div class="ui segment">
          <div style="position: absolute;right: 20px;">
            <div class="ui breadcrumb"><a class="section" href="inicio"><i class="home icon"></i></a>
              <div class="divider">/</div><a class="section">Configurações</a>
          ...
          <p></p>
          <div class="ui top attached tabular menu"><a class="item active" data-tab="first">Gerenciar Usuário</a><a class="item" data-tab="second">Cadastrar Usuário</a></div>
            ...
            <table class="ui compact selectable celled unstackable table" id="tableUsuarios">
              <thead>
                <tr>
                  ...
                  <th class="one wide" style="text-align: center;" data-tooltip="Representa se o usuário esta Ativo ou Inativo">Status</th>
                </tr>
              </thead>
            ...
            <div class="ui form segment">
              <form id="formUsuarios" name="formUsuarios">@csrf
                ...
                <div style="text-align: center">
                  <button class="ui green labeled icon button" type="submit" style="min-width: 166px"><i class="plus icon"></i>Salvar</button>
                  <button class="ui blue right labeled icon button" type="reset" style="min-width: 166px"><i class="child icon"></i>Novo</button>
                  <button class="ui yellow labeled icon button" type="button"><i class="redo icon"></i>Resetar senha</button>
                  <button class="ui red right labeled icon button" type="submit" form="formDelete" style="min-width: 166px"><i class="remove icon"></i>Excluir</button>
                </div>
              </form>
