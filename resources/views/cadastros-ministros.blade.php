    ...
    <main class="pusher">
      ...
      <div class="ui container" style="margin-top: 100px; margin-bottom: 20px; display:none;" id="windows">
        <div class="ui segment">
          ...
          <p></p>
          <div class="ui top attached tabular menu"><a class="item active" data-tab="first">Minístros</a><a class="item" data-tab="second">Cadastrar</a></div>
          ...
          <div class="ui bottom attached tab segment" data-tab="second">
            <form id="cadastros_presbiteros" name="cadastros_presbiteros">@csrf
              <div class="ui form">
                <div class="fields">
                ...
                <div class="fields">
                  ...
                  <div class="five wide field" data-toolip="Estado em que nasceu">
                    <label>Estado</label>
                    <select class="ui fluid search dropdown" name="nascimento_id_estado"></select>
                  </div>
                  <div class="eight wide field" id="div_cidade">
                    <label>Cidade</label>
                    <select class="ui fluid search dropdown" name="nascimento_id_cidade" id="nascimento_id_cidade"></select>
                ...
                <div class="fields">
                  ...
                  <div class="ui calendar bottom left four wide field">
                    <label>Data de Nascimento</label>
                    <input class="datepicker2" type="date" name="conjuge_nascimento" placeholder="Data de Nascimento do Cônjuge">
                  </div>
                </div>
                <div class="fields">
                  <div class="sixteen wide field">
                    <label>Nome dos Dependentes</label>
                    <input type="text" name="nome_filhos" placeholder="Nome dos Dependentes. OSB. use ; para separar os nomes">
                  </div>
                </div>
                <div class="fields">
                  <div class="six wide field">
                ...
                <div class="fields">
                  ...
                  <div class="five wide field" id="div_cidade">
                    <label>Cidade</label>
                    <select class="ui fluid search dropdown" name="endereco_id_cidade" id="endereco_id_cidade"></select>
                    <div class="ui active inline small loader" style="display:none" id="loader_cidade"></div>
                  </div>
                  <div class="two wide field">
                    <label>CEP</label>
              ...
              <div class="ui segments">
                <div class="ui horizontal segments">
                  <div class="ui segment"><span style="color: lightslategray;"><strong>Usuário inclusão:</strong></span><span style="color: lightslategray;">
                      &nbsp;
                      Kallew Pavão
                      &nbsp;</span><span style="float: right;color: lightslategray;"><strong>Data:</strong>&nbsp;
                      01/01/2018</span></div>
                  <div class="ui segment"><span style="color: lightslategray;"><strong>Última alteração:</strong></span><span style="color: lightslategray;">
                      &nbsp;
                      Kallew Pavão
                      &nbsp;</span><span style="float: right;color: lightslategray;"><strong>Data:</strong>&nbsp;
                      01/01/2018</span></div>
