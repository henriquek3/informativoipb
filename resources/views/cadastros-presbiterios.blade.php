...
<main class="pusher"><!-- Header Mobile-->
    ...
    <div class="ui container" style="margin-top: 100px; margin-bottom: 20px; display:none;" id="windows">
        <div class="ui segment"><!---->
            ...
            <p></p>
            <div class="ui top attached tabular menu"><a class="item active" data-tab="first">Presbitérios</a><a
            ...
            <div class="ui bottom attached tab segment" data-tab="second">
                <form id="cadastros_presbiterios" name="cadastros_presbiterios">
                    <div class="ui form">
                        <div class="fields">
                            <div class="sixteen wide required field"><label>Sínodos</label> <select
                                        class="ui search dropdown" name="id_sinodo">
                                    <option></option>
