        ...
        <div class="ui segment">
          ...
          <div class="ui bottom attached tab segment active" data-tab="first">
              ...
              <div class="ui form">
                <div class="fields">
                  ...
                  <div class="four wide field">
                    <label>Sínodo</label>
                    <select class="ui fluid search selection dropdown disabled"></select>
                  </div>
                  <div class="four wide field">
            ...
            <table class="ui compact selectable celled red table" id="tbl_relatorios_conselhos">
              <thead>
                <tr>
                  <th class="sexteen wide center aligned">I - Identificação da Igreja / Congregação Presbiterial</th>
                </tr>
                <tbody id="tbody_relatorios_conselhos"></tbody>
              </thead>
            </table>
            ...
            <div class="ui form">
              <div class="fields">
                <div class="two wide field">
                  <label class="ui ribbon label">1. ORGANIZAÇÃO</label>
                </div>
              </div>
              <div class="inline fields">
                <div class="four wide field">
                  <label>1.1. Os imóveis estão documentados?</label>
                </div>
                <div class="two wide field">
                  <label>Sim</label>
                ...
                <div class="five wide field">
                  <label>1.4. Apresentou declarações do ano anterior?</label>
                </div>
                <div class="five wide field">
                  <label>IRenda</label>
              ...
              <div class="inline fields">
                <div class="four wide field">
                  <label>1.2. Há inventário dos móveis e utensílios?</label>
                </div>
                <div class="two wide field">
                  <label>Sim</label>
                ...
                <div class="five wide field">
                  <label>1.5. Inventário atualizado?</label>
                </div>
                <div class="two wide field">
                  <label>Sim</label>
              ...
              <div class="inline fields">
                <div class="four wide field">
                  <label>1.3. Os Róis de Membros estão atualizados</label>
                </div>
                <div class="two wide field">
                  <label>Sim</label>
                  <input name="radio5" type="radio">
                  <label>Não</label>
                  <input name="radio5" type="radio" checked="checked">
                </div>
                <div class="five wide field">
                  <label>1.6. Quantas Congregações da Igreja?</label>
                </div>
                <div class="two wide field">
                  <input type="text" name="quantas_congregacoes">
                </div>
              </div>
              <div class="fields">
                <div class="two wide field">
                  <label class="ui ribbon label">2. SUPERVISÃO ESPIRITUAL</label>
                </div>
              </div>
              <div class="fields">
                <div class="ui red header horizontal inverted divider">
                  <h4>2.1. Adoração e Comunhão</h4>
                </div>
              </div>
              <div class="inline fields">
                <div class="five wide field">
                  <label>2.1.1. Nº de celebrações da Santa Ceia em grupos:</label>
                </div>
                <div class="two wide field">
                  <input type="text">
                </div>
                <div class="four wide field">
                  <label>Nº de Ministrações de Ceia à indivíduos:</label>
                </div>
                <div class="two wide field">
                  <input type="text">
                </div>
              ...
              <div class="fields">
                <div class="three wide field">
                  <label>2.2. Evangelização e Missões</label>
                </div>
              </div>
              <div class="inline fields">
                <div class="five wide field">
              ...
              <div class="inline fields">
                <div class="ui red header horizontal inverted divider">
                  <h4>2.3 Educação e Aperfeiçoamento</h4>
                </div>
              </div>
              <div class="inline fields">
                <div class="four wide field">
                ...
                <div class="two wide field">
                  <label>Sim</label>
                  <input name="radio6" type="radio">
                  <label>Não</label>
                  <input name="radio6" type="radio" checked="checked">
                </div>
                <div class="three wide field">
                ...
                <div class="two wide field">
                  <label>Sim</label>
                  <input name="radio9" type="radio">
                  <label>Não</label>
                  <input name="radio9" type="radio" checked="checked">
                </div>
              </div>
              <div class="inline fields">
                <div class="four wide field">
                ...
                <div class="two wide field">
                  ...
                  <label>Não</label>
                  <input name="radio7" type="radio" checked="checked">
                </div>
                <div class="three wide field">
              ...
              <div class="inline fields">
                ...
                <div class="two wide field">
                  <label>Sim</label>
                  <input name="radio8" type="radio">
                  <label>Não</label>
                  <input name="radio8" type="radio" checked="checked">
                </div>
                <div class="three wide field">
              ...
              <div class="inline fields">
                <div class="ui red header horizontal inverted divider">
                  <h4>2.4. Ação Social e Visitação</h4>
                </div>
              </div>
              <div class="inline fields">
              ...
              <div class="fields">
                <div class="four wide field">
                  <label class="ui ribbon label">3. SUPERVISÃO ADMINISTRATIVA</label>
                </div>
              </div>
              <div class="inline fields">
                <div class="eight wide field">
              ...
              <div class="inline fields">
                <div class="sixteen wide field">
                  <textarea rows="4" placeholder="Escreva os nomes dos Presbíteros/Diáconos que estão com mandatos a vencer"></textarea>
                </div>
              </div>
              <div class="inline fields">
                <div class="one wide field">
              ...
              <div class="fields">
                <div class="four wide field">
                  <label class="ui ribbon label">4. PLANEJAMENTO ESTRATÉGICO</label>
                </div>
              </div>
              <div class="inline fields">
                <div class="six wide field">
              ...
              <div class="fields">
                <div class="four wide field">
                  <label class="ui ribbon label">5. PATRIMÔNIO:</label>
                </div>
              </div>
              <div class="inline fields">
                <div class="six wide field">
              ...
              <div style="text-align: center; padding-button: 50px;">
                <div class="sixteen wide field">
                  <label>Assinatura Secretário</label>
                </div>
              </div>
