...
<main class="pusher"><!-- Header Mobile-->
    ...
    <div class="ui container" style="margin-top: 100px; margin-bottom: 20px; display:none;" id="windows">
        <div class="ui segment"><!---->
            ...
            <p></p>
            <div class="ui top attached tabular menu"><a class="item active" data-tab="first">Relatórios</a></div>
            <div class="ui bottom attached tab segment active" data-tab="first">
                <table class="ui compact selectable celled red table" id="tbl_relatorios_conselhos">
                    <thead>
                    <tr>
                        <th class="sexteen wide center aligned">Relatório do Conselho ou Mesa Adiministrativa</th>
                    </tr>
                    <tbody id="tbody_relatorios_conselhos"></tbody>
                    </thead></table>
                <form id="relatorios_conselhos" name="relatorios_conselhos">
                    <div class="ui form">
                        <div class="fields">
                            <div class="two wide field"><label>Ano</label> <input type="text" disabled=""></div>
                            <div class="four wide field"><label>Sínodo</label> <select
                                        class="ui fluid search selection dropdown disabled"></select></div>
                            <div class="four wide field"><label>Presbitério</label> <select
                                        class="ui fluid search selection dropdown disabled"></select></div>
                            <div class="four wide field"><label>Igreja</label> <select
                                        class="ui fluid search selection dropdown disabled"></select></div>
                            <div class="two wide field"><label>Sigla</label> <input type="text" disabled=""></div>
                        </div>
                    </div>
                </form>
                <table class="ui compact selectable celled red table" id="tbl_relatorios_conselhos">
                    <thead>
                    <tr>
                        <th class="sexteen wide center aligned">I - Identificação da Igreja / Congregação Presbiterial
                        </th>
                    </tr>
                    <tbody id="tbody_relatorios_conselhos"></tbody>
                    </thead></table>
                <div class="ui form">
                    ...
                    <div class="fields">
                        <div class="eight wide field"><label>Endereço</label> <input type="text" disabled=""></div>
                        <div class="two wide field"><label>Número</label> <input type="text" disabled=""></div>
                        <div class="three wide field"><label>Complemento</label> <input type="text" disabled=""></div>
                        <div class="three wide field"><label>Bairro</label> <input type="text" disabled=""></div>
                    </div>
                    <div class="fields">
                        ...
                        <div class="four wide field"><label>Cidade</label> <select
                                    class="ui fluid search dropdown disabled"></select></div>
                        <div class="three wide field"><label>CEP</label> <input type="text" disabled=""></div>
                        <div class="two wide field"><label>Cx. P</label> <input type="text" disabled=""></div>
                        <div class="three wide field"><label>CEP Cx. P</label> <input type="text" disabled=""></div>
                    </div>
                    <div class="fields">
                        <div class="two wide field"><label>Telefone</label> <input type="text" disabled=""></div>
                        <div class="four wide field"><label>E-Mail</label> <input type="text" disabled=""></div>
                        <div class="four wide field"><label>HomePage</label> <input type="text" disabled=""></div>
                        <div class="three wide field"><label>CNPJ</label> <input type="text" disabled=""></div>
                        <div class="three wide field"><label>Data Organização</label> <input type="text" disabled="">
                        </div>
                    </div>
                </div>
                <table class="ui compact selectable called red table" id="tbl_relatorios_conselhos">
                    <thead>
                    <tr>
                        <th class="sexteen wide center aligned">II - Informações do Trabalho</th>
                    </tr>
                    <tbody id="tbody_relatorios_conselhos"></tbody>
                    </thead></table>
                <div class="ui form">
                    <div class="fields">
                        <div class="two wide field"><label class="ui ribbon label">1. ORGANIZAÇÃO</label></div>
                    </div>
                    <div class="inline fields">
                        <div class="four wide field"><label>1.1. Os imóveis estão documentados?</label></div>
                        <div class="two wide field"><label>Sim</label> <input name="radio1" type="radio">
                            <label>Não</label> <input name="radio1" type="radio" checked="checked"></div>
                        <div class="five wide field"><label>1.4. Apresentou declarações do ano anterior?</label></div>
                        <div class="five wide field"><label>IRenda</label> <input name="radio2" type="radio"> <label>RAIS</label>
                            <input name="radio2" type="radio"> <label>DIRF</label> <input name="radio2" type="radio">
                        </div>
                    </div>
                    <div class="inline fields">
                        <div class="four wide field"><label>1.2. Há inventário dos móveis e utensílios?</label></div>
                        <div class="two wide field"><label>Sim</label> <input name="radio3" type="radio">
                            <label>Não</label> <input name="radio3" type="radio" checked="checked"></div>
                        <div class="five wide field"><label>1.5. Inventário atualizado?</label></div>
                        <div class="two wide field"><label>Sim</label> <input name="radio4" type="radio">
                            <label>Não</label> <input name="radio4" type="radio" checked="checked"></div>
                    </div>
                    <div class="inline fields">
                        <div class="four wide field"><label>1.3. Os Róis de Membros estão atualizados</label></div>
                        <div class="two wide field"><label>Sim</label> <input name="radio5" type="radio">
                            <label>Não</label> <input name="radio5" type="radio" checked="checked"></div>
                        <div class="five wide field"><label>1.6. Quantas Congregações da Igreja?</label></div>
                        <div class="two wide field"><input type="text" name="quantas_congregacoes"></div>
                    </div>
                    <div class="fields">
                        <div class="two wide field"><label class="ui ribbon label">2. SUPERVISÃO ESPIRITUAL</label>
                        </div>
                    </div>
                    <div class="fields">
                        <div class="ui red header horizontal inverted divider"><h4>2.1. Adoração e Comunhão</h4></div>
                    </div>
                    <div class="inline fields">
                        <div class="five wide field"><label>2.1.1. Nº de celebrações da Santa Ceia em grupos:</label>
                        </div>
                        <div class="two wide field"><input type="text"></div>
                        <div class="four wide field"><label>Nº de Ministrações de Ceia à indivíduos:</label></div>
                        <div class="two wide field"><input type="text"></div>
                        <div class="one wide field"><label>Nº Total</label></div>
                        <div class="two wide field"><input type="text"></div>
                    </div>
                    <div class="fields">
                        <div class="three wide field"><label>2.2. Evangelização e Missões</label></div>
                    </div>
                    <div class="inline fields">
                        <div class="five wide field"><label>2.2.1. Nº de atividades evangelísticas:*</label></div>
                        <div class="two wide field"><input type="text"></div>
                        <div class="ui tiny message"><label>* em templos e residências; recintos públicos ou ar livre;
                                imprensa escrita, rádio e TV, etc.</label></div>
                    </div>
                    <div class="inline fields">
                        <div class="five wide field"><label>2.2.2. Textos distribuídos:</label></div>
                        <div class="one wide field"><label>Bíblias</label></div>
                        <div class="one wide field"><input type="text"></div>
                        <div class="one wide field"><label>Novo Testamento</label></div>
                        <div class="one wide field"><input type="text"></div>
                    ...
                    <div class="inline fields">
                        <div class="five wide field"><label>2.2.3. Trabalho missionário com:</label></div>
                        <div class="two wide field ui checkbox"><label>JMN</label> <input name="check1" type="checkbox">
                        </div>
                        <div class="two wide field ui checkbox"><label>APMT</label> <input name="check2"
                                                                                           type="checkbox"></div>
                        <div class="three wide field ui checkbox"><label>Parceria com o PMC</label> <input name="check3"
                                                                                                           type="checkbox">
                        </div>
                        <div class="three wide field ui checkbox"><label>Plantação de Igrejas</label> <input
                                    name="check4" type="checkbox"></div>
                    </div>
                    <div class="inline fields">
                        <div class="five wide field"><label>2.2.4.Outra participação missionária:</label></div>
                        <div class="eleven wide field"><input type="text"></div>
                    </div>
                    <div class="inline fields">
                        <div class="ui red header horizontal inverted divider"><h4>2.3 Educação e Aperfeiçoamento</h4>
                        </div>
                    </div>
                    <div class="inline fields">
                        <div class="four wide field"><label>2.3.1. Para professores de Escola Dominical:</label></div>
                        <div class="two wide field"><label>Sim</label> <input name="radio6" type="radio">
                            <label>Não</label> <input name="radio6" type="radio" checked="checked"></div>
                        <div class="three wide field"><label>2.3.4. Para Liderança:</label></div>
                        <div class="two wide field"><label>Sim</label> <input name="radio9" type="radio">
                            <label>Não</label> <input name="radio9" type="radio" checked="checked"></div>
                    </div>
                    <div class="inline fields">
                        <div class="four wide field"><label>2.3.2. Para Equipe de Música:</label></div>
                        <div class="two wide field"><label>Sim</label> <input name="radio7" type="radio">
                            <label>Não</label> <input name="radio7" type="radio" checked="checked"></div>
                        <div class="three wide field"><label>2.3.5. Nº de Grupos Corais:</label></div>
                        <div class="two wide field"><input type="text"></div>
                    </div>
                    <div class="inline fields">
                        <div class="four wide field"><label>2.3.3. Para Oficiais (Presbíteros e Diáconos)</label></div>
                        <div class="two wide field"><label>Sim</label> <input name="radio8" type="radio">
                            <label>Não</label> <input name="radio8" type="radio" checked="checked"></div>
                        <div class="three wide field"><label>2.3.6. Nº de Conjuntos Musicais:</label></div>
                        <div class="two wide field"><input type="text"></div>
                    </div>
                    <div class="inline fields">
                        <div class="ui red header horizontal inverted divider"><h4>2.4. Ação Social e Visitação</h4>
                        </div>
                    </div>
                    <div class="inline fields">
                        <div class="six wide field"><label>2.4.1.Nº de atos beneficentes realizados pela Junta
                                Diaconal:</label></div>
                        <div class="two wide field"><input type="text"></div>
                        <div class="three wide field"><label>Por outros departamentos:</label></div>
                        <div class="two wide field"><input type="text"></div>
                        <div class="one wide field"><label>Total</label></div>
                        <div class="two wide field"><input type="text"></div>
                    </div>
                    <div class="inline fields">
                        <div class="six wide field"><label>2.4.2.Nº de visitas feitas por presbíteros e
                                diáconos:</label></div>
                        <div class="two wide field"><input type="text"></div>
                        <div class="three wide field"><label>Por outros departamentos:</label></div>
                        <div class="two wide field"><input type="text"></div>
                    ...
                    <div class="fields">
                        <div class="four wide field"><label class="ui ribbon label">3. SUPERVISÃO ADMINISTRATIVA</label>
                        </div>
                    </div>
                    <div class="inline fields">
                        <div class="eight wide field"><label>3.1. A Igreja enviou fielmente os Dízimos dos Dízimos à
                                Tesouraria IPB:</label></div>
                        <div class="one wide field"><label>Sim</label> <input name="radio9" type="radio"></div>
                        <div class="one wide field"><label>Não</label> <input name="radio9" type="radio"
                                                                              checked="checked"></div>
                    </div>
                    <div class="inline fields">
                        <div class="ui red header horizontal inverted divider"><h4>REUNIÕES</h4></div>
                    </div>
                    <div class="inline fields">
                        ...
                        <div class="four wide field"><select class="ui fluid search dropdown">
                                ...
                                <option>Congregação Presbiterial</option>
                                <option>Ambas</option>
                            </select></div>
                    ...
                    <div class="inline fields">
                        ...
                        <div class="one wide field"><label>Sim</label> <input name="radio10" type="radio"></div>
                        <div class="one wide field"><label>Não</label> <input name="radio10" type="radio"></div>
                    </div>
                    <div class="inline fields">
                        <div class="seven wide field"><label>3.8. Há oficiais com mandato a vencer no ano a
                                seguir?</label></div>
                        <div class="one wide field"><label>Sim</label> <input name="radio11" type="radio"></div>
                        <div class="one wide field"><label>Não</label> <input name="radio11" type="radio"></div>
                    </div>
                    <div class="inline fields">
                        <div class="two wide field"><label>Nº Presbíteros:</label></div>
                        <div class="two wide field"><input type="text"></div>
                        <div class="two wide field"><label>Nº Diáconos</label></div>
                        <div class="two wide field"><input type="text"></div>
                    </div>
                    <div class="inline fields">
                    ...
                    <div class="inline fields">
                        <div class="sixteen wide field"><textarea rows="4"
                    ...
                    <div class="inline fields">
                        ...
                        <div class="one wide field"><label>Sim</label> <input name="radio12" type="radio"></div>
                        <div class="one wide field"><label>Não</label> <input name="radio12" type="radio"></div>
                        <div class="one wide field"></div>
                        <div class="two wide field"><label>IPB-PREV?</label></div>
                        <div class="one wide field"><label>Sim</label> <input name="radio13" type="radio"></div>
                        <div class="one wide field"><label>Não</label> <input name="radio13" type="radio"></div>
                    </div>
                    <div class="inline fields">
                        <div class="six wide field"><label>3.9. Idem, dos livros e relatórios das sociedades?</label>
                        </div>
                        <div class="one wide field"><label>Sim</label> <input name="radio14" type="radio"></div>
                        <div class="one wide field"><label>Não</label> <input name="radio14" type="radio"></div>
                        <div class="six wide field"><label>3.11. Houve contribuição para causas extra-locais?</label>
                        </div>
                        <div class="one wide field"><label>Sim</label> <input name="radio15" type="radio"></div>
                        <div class="one wide field"><label>Não</label> <input name="radio15" type="radio"></div>
                    </div>
                    <div class="inline fields">
                        <div class="six wide field"><label>3.10. Houve nomeação de conselheiros às Sociedades?</label>
                        </div>
                        <div class="one wide field"><label>Sim</label> <input name="radio16" type="radio"></div>
                        <div class="one wide field"><label>Não</label> <input name="radio16" type="radio"></div>
                        <div class="six wide field"><label>3.12. Contribuiu com Previdência Social pastor(es)?</label>
                        </div>
                        <div class="one wide field"><label>Sim</label> <input name="radio17" type="radio"></div>
                        <div class="one wide field"><label>Não</label> <input name="radio17" type="radio"></div>
                    </div>
                    <div class="inline fields">
                        <div class="eight wide field"><label>3.13. Reforma e/ou Construção em projeto:</label></div>
                        <div class="eight wide field"><label>3.14. Reforma e/ou Construção em andamento:</label></div>
                    </div>
                    <div class="inline fields">
                        <div class="eight wide field"><textarea rows="4"></textarea></div>
                        <div class="eight wide field"><textarea rows="4"></textarea></div>
                    </div>
                    <div class="fields">
                        <div class="four wide field"><label class="ui ribbon label">4. PLANEJAMENTO ESTRATÉGICO</label>
                        </div>
                    </div>
                    <div class="inline fields">
                        <div class="six wide field"><label>4.1 A Igreja tem Planejamento Estratégico?</label></div>
                        <div class="one wide field"><label>Sim</label> <input name="radio18" type="radio"></div>
                        <div class="one wide field"><label>Não</label> <input name="radio18" type="radio"></div>
                    </div>
                    <div class="inline fields">
                    ...
                    <div class="fields">
                        <div class="four wide field"><label class="ui ribbon label">5. PATRIMÔNIO:</label></div>
                    </div>
                    <div class="inline fields">
                        <div class="six wide field"><label>5.1. A Igreja tem Seguro do bem patrimonial?</label></div>
                        <div class="one wide field"><label>Sim</label> <input name="radio19" type="radio"></div>
                        <div class="one wide field"><label>Não</label> <input name="radio19" type="radio"></div>
                        <div class="six wide field"><label>5.2. Tem Alvará de Funcionamento?</label></div>
                        <div class="one wide field"><label>Sim</label> <input name="radio20" type="radio"></div>
                        <div class="one wide field"><label>Não</label> <input name="radio20" type="radio"></div>
                    </div>
                    <div class="inline fields">
                        <div class="six wide field"><label>5.3. Tem Licença do Corpo de Bombeiros em dia?</label></div>
                        <div class="one wide field"><label>Sim</label> <input name="radio21" type="radio"></div>
                        <div class="one wide field"><label>Não</label> <input name="radio21" type="radio"></div>
                        <div class="six wide field"><label>5.4. Tem Certificado Digital?</label></div>
                        <div class="one wide field"><label>Sim</label> <input name="radio22" type="radio"></div>
                        <div class="one wide field"><label>Não</label> <input name="radio22" type="radio"></div>
                    </div>
                    <div style="text-align: center; padding-top: 50px;">
                        <div class="sixteen wide field ui fitted divider"></div>
                    </div>
                    <div style="text-align: center; padding-button: 50px;">
                        <div class="sixteen wide field"><label>Assinatura Secretário</label></div>
                    </div>
...
<script src="js/app/main-app.js"></script><!-- Page specific javascripts--></body>
</html>