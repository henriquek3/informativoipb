    ...
    <main class="pusher">
      ...
      <div class="ui container" style="margin-top: 100px; margin-bottom: 20px; display:none;" id="windows">
        <div class="ui segment">
          ...
          <p></p>
          <div class="ui top attached tabular menu"><a class="item active" data-tab="first">Meu Usuário</a><a class="item" data-tab="second">Alterar Usuário</a></div>
          ...
          <div class="ui bottom attached tab segment" data-tab="second">
            <div class="ui form segment">
              ...
              <div class="fields">
                ...
                <div class="three wide field required disabled">
                  <label>CPF</label>
                  <input type="text">
                </div>
              </div>
              ...
              <div class="ui segments">
                <div class="ui segment" style="text-align: center; background-color: #F9FAFB">
                  <p><strong>INFORMAÇÕES SOBRE O PREENCHIMENTO</strong></p>
                </div>
                <div class="ui horizontal segments">
                  <div class="ui segment"><span><strong>Usuário cadastrado por:</strong></span><span>
                      &nbsp;
                      Kallew Pavão
              ...
              <div style="text-align: center">
                ...
                <button class="ui yellow right labeled icon button" type="button"><i class="redo icon"></i>Gerar Nova Senha</button>
              </div>
            </div>
          </div>
        </div>
