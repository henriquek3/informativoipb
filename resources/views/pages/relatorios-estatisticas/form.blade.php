            ...
            <div class="ui form segment">
                <div class="fields">
                    ...
                    <div class="seven wide field">
                        <label>Sínodo</label>
                        <input type="text" name="sinodo" value="{{auth()->user()->presbitero->igreja->presbiterio->sinodo->nome}}" readonly="">
                    </div>
                    <div class="seven wide field" id="div_presbiterio">
                        <label>Presbitério</label>
                        <input type="text" name="presbiterio" value="{{auth()->user()->presbitero->igreja->presbiterio->nome}}" readonly="">
                    </div>
