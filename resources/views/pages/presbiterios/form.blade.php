...
<main class="pusher">
    ...
    <!-- Mensagens de Erro-->@if($errors->any())
        ...
        <div class="ui clearing"></div>
        <div class="ui segment"><a class="ui right floated blue tiny button" href="/cadastros/presbiterios"><i
            ...
            <form id="formResource" name="formResource" action="{{ url()->current() }}" method="post">@csrf
                ...
                <div class="ui segments">
                    <div class="ui horizontal segments">
                        <div class="ui segment"><span style="color: lightslategray;"><strong>Usuário inclusão:</strong></span><span
...
<script src="{{asset('js/app/cadastros-presbiterios-app.js')}}"></script>
<script type="text/javascript" async>
    $(document).ready(function () {
        //$('.ui.dropdown').dropdown();
    });
</script>@isset($resource)
    <script type="text/javascript" async>
        try {
