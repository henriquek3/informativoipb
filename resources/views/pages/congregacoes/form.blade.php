...
@section('content')
    ...
    <div class="ui raised segment">
        <a class="ui right floated blue tiny button" href="/cadastros/igrejas/{{$id_igreja}}/editar">
            <i class="reply icon"></i>
            Voltar
        </a>
        <h3 class="ui floated header" style="padding-top: 6px;padding-left: 10px;"><i class="edit outline icon"></i>
        </h3>
        <h1 class="ui floated header" style="margin-left: -10px;">Cadastro de Congregações
            <div class="sub header" style="margin-left: -40px;">Informações cadastrais de congregações.
            </div>
        </h1>
            ...
            <div class="ui form">
                <div class="fields">
                    <div class="sixteen wide field">
                        <label>Igreja Mãe</label>
                        <input type="text" disabled value="{{$nome_igreja}}">
                    </div>
                </div>
                <div class="fields">
