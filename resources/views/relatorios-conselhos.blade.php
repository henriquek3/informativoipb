        ...
        <div class="ui segment">
          <div style="position: absolute;right: 20px;">
            <div class="ui breadcrumb"><a class="section" href="inicio"><i class="home icon"></i></a>
              <div class="divider">/</div><a class="section">Relatórios</a>
          ...
          <p></p>
          <div class="ui top attached tabular menu"><a class="item" data-tab="first">Relatórios</a><a class="item active" data-tab="second">Responder</a></div>
          ...
          <form class="ui bottom attached tab segment active" data-tab="second" name="relatorios_conselhos" id="relatorios_conselhos">@csrf
            ...
            <div class="ui form segment">
              <div class="fields">
                <div class="two wide field">
                  <label>Ano</label>
                  <input type="text" value="2018" name="ano" disabled="">
                </div>
              ...
              <div class="ui form segment">
                ...
                <div class="fields">
                  ...
                  <div class="three wide field">
                    ...
                    <input type="text" disabled="" name="endereco_cx_cep">
                  </div>
                </div>
                <div class="fields">
                  <div class="two wide field">
            ...
            <div class="ui segments">
              ...
              <div class="ui form segment">
                <div class="ui red ribbon label" style="font-size:0.92857143em;">1. ORGANIZAÇÃO</div><strong style="color:#FF695E;">1.1. ORGANIZAÇÃO</strong>
              </div>
              <div class="ui form segment">
                <div class="inline fields">
                  <div class="eight wide field" data-tooltip="Os imóveis que pertencem a igreja estão devidamente documentados?">
                  ...
                  <div class="eight wide field" data-tooltip="A igreja apresentou no ano passado quais declarações Fiscais?">
                    <div class="eight wide field"><span class="ui label">1.1.4</span>
                      <label>Declarações Anteriores</label>
                    </div>
                    <div class="eight wide field">
                      <div class="ui checkbox">
                        <input name="or_declaracao_ano_anterior" value="IRenda" type="checkbox">
                        <label>IRenda</label>
                      </div>
                      <div class="ui checkbox">
                        <input name="or_declaracao_ano_anterior" value="RAIS" type="checkbox">
                        <label>RAIS</label>
                      </div>
                      <div class="ui checkbox">
                        <input name="or_declaracao_ano_anterior" value="DIRF" type="checkbox">
                        <label>DIRF</label>
                      </div>
                    </div>
                  </div>
                ...
                <div class="inline fields">
                  <div class="eight wide field" data-tooltip="A igreja organizou o inventário dos imóveis e utensílios?">
                  ...
                  <div class="eight wide field" data-tooltip="Caso a igreja tenha inventário, ele esta devidamente atualizado?">
                ...
                <div class="inline fields">
                  <div class="eight wide field" data-tooltip="A igreja conta com o rol de membro atualizado?">
                    ...
                    <div class="six wide field">
                      ...
                      <div class="ui radio checkbox">
                        <input name="or_rol_membros_atualizado" type="radio" value="0" checked="checked">
                        <label>Não</label>
                      </div>
                    </div>
                  </div>
                  <div class="eight wide field" data-tooltip="Quantas congregações estão vinculadas a igreja?">
              ...
              <div class="ui segment">
                <div class="ui red ribbon label" style="font-size:0.92857143em;">2. SUPERVISÃO ESPIRITUAL</div><strong style="color:#FF695E;">2.1. ADORAÇÃO E COMUNHÃO</strong>
              </div>
              <div class="ui form segment">
                <div class="inline fields">
              ...
              <div class="ui segment">
                <div class="ui red ribbon label" style="font-size:0.92857143em;">2. SUPERVISÃO ESPIRITUAL</div><strong style="color:#FF695E;">2.2. EVANGELIZAÇÃO E MISSÕES</strong>
              </div>
              <div class="ui form segment">
                <div class="inline fields">
                  <div class="five wide field" data-tooltip="Qual o número de atividades evangelísticas realizadas?">
                  ...
                  <div class="ui tiny message">
                    <label>* em templos e residências; recintos públicos ou ar livre; imprensa escrita, rádio e TV, etc.</label>
                  </div>
                </div>
                <div class="inline fields">
                ...
                <div class="inline fields">
                  ...
                  <div class="two wide field ui checkbox">
                    <label>JMN</label>
                    <input name="se_trabalho_missionario" type="checkbox" value="JMN">
                  </div>
                  <div class="two wide field ui checkbox">
                    <label>APMT</label>
                    <input name="se_trabalho_missionario" type="checkbox" value="APMT">
                  </div>
                  <div class="three wide field ui checkbox">
                    <label>Parceria com o PMC</label>
                    <input name="se_trabalho_missionario" type="checkbox" value="PMC">
                  </div>
                  <div class="three wide field ui checkbox">
                    <label>Plantação de Igrejas</label>
                    <input name="se_trabalho_missionario" type="checkbox" value="Plantacao_Igrejas">
                  </div>
                </div>
                <div class="inline fields">
              ...
              <div class="ui segment">
                <div class="ui red ribbon label" style="font-size:0.92857143em;">2. SUPERVISÃO ESPIRITUAL</div><strong style="color:#FF695E;">2.3 EDUCAÇÃO E APERFEIÇOAMENTO</strong>
              </div>
              <div class="ui form segment">
                <div class="inline fields">
                  ...
                  <div class="three wide field" data-tooltip="Houve aperfeiçoamento para Liderança da Igreja?">
                ...
                <div class="inline fields">
                  <div class="four wide field" data-tooltip="Houve aperfeiçoamento para Presbíteros e Diáconos?">
              ...
              <div class="ui segment">
                <div class="ui red ribbon label" style="font-size:0.92857143em;">2. SUPERVISÃO ESPIRITUAL</div><strong style="color:#FF695E;">2.4 AÇÃO SOCIAL E VISITAÇÃO</strong>
              </div>
              <div class="ui form segment">
                <div class="inline fields">
                  <div class="six wide field" data-tooltip="Nº de atos benificientes realizados pela Junta Diaconal.">
                  ...
                  <div class="three wide field" data-tooltip="Nº de atos benificientes realizados por outro Departamento.">
                ...
                <div class="inline fields">
                  <div class="six wide field" data-tooltip="Nº de visitas realizadas por Presbíteros e Diáconos.">
                  ...
                  <div class="three wide field" data-tooltip="Nº de visitas realizadas por outro Departamento.">
                    <label>Por outros departamentos:</label>
                  </div>
                  <div class="two wide field">
              ...
              <div class="ui segment">
                <div class="ui red ribbon label" style="font-size:0.92857143em;">3. SUPERVISÃO ADMINISTRATIVA</div><strong style="color:#FF695E;">3.1. SUPERVISÃO ADMINISTRATIVA</strong>
              </div>
              <div class="ui form segment">
                <div class="inline fields">
                  <div class="eight wide field">
              ...
              <div class="ui form segment">
                ...
                <div class="inline fields">
                  <div class="two wide field" data-tooltip="Nº Presbíteros com mandato a vencer no próximo ano.">
                ...
                <div class="inline fields">
                  <div class="sixteen wide field">
                    <textarea rows="4" name="sa_id_oficiais_vencimento" placeholder="Escreva os nomes dos Presbíteros/Diáconos que estão com mandatos a vencer"></textarea>
                  </div>
                </div>
                <div class="inline fields">
                  <div class="one wide field">
                ...
                <div class="inline fields">
                  <div class="eight wide field">
                    <textarea rows="4" name="sa_reforma_construcao_projeto" placeholder="Cite a(s) reforma(s) ou contrução(ões) que estão no projeto."></textarea>
                  </div>
                  <div class="eight wide field">
                    <textarea rows="4" name="sa_reforma_construcao_andamento" placeholder="Cite a(s) reforma(s) ou contrução(ões) que estão em andamento."></textarea>
                  </div>
                </div>
              </div>
              <div class="ui segment">
                <div class="ui red ribbon label" style="font-size:0.92857143em;">4. PLANEJAMENTO ESTRATÉGICO</div><strong style="color:#FF695E;">4.1. PLANEJAMENTO ESTRATÉGICO</strong>
              </div>
              <div class="ui form segment">
                <div class="inline fields">
                  <div class="six wide field">
                  ...
                  <div class="one wide field">
                    <label>Sim</label>
                    <input name="pe_exite_pe" type="radio" value="1">
                  </div>
                  <div class="one wide field">
                    <label>Não</label>
                    <input name="pe_exite_pe" type="radio" checked="checked" value="0">
                  </div>
                </div>
                <div class="inline fields">
                  <div class="eight wide field">
                  ...
                  <div class="eight wide field">
                    <label>4.3. Quais os objetivos propostos e NÃO alcançados? Identificar as dificuldades.</label>
                  </div>
                </div>
                <div class="inline fields">
                  <div class="eight wide field">
                    <textarea rows="4" name="pe_objetivos_sucesso" placeholder="Cite os objetivos que foram propostos e alcançados."></textarea>
                  </div>
                  <div class="eight wide field">
                    <textarea rows="4" name="pe_objetivos_falha_dificuldades" placeholder="Cite os objetivos que foram propostos mas NÃO foram alcançados."></textarea>
                  </div>
                </div>
              </div>
              <div class="ui segment">
                <div class="ui red ribbon label" style="font-size:0.92857143em;">5. PATRIMÔNIO</div><strong style="color:#FF695E;">5.1 PATRIMÔNIO</strong>
              </div>
              <div class="ui form segment">
                <div class="inline fields">
                  <div class="six wide field">
                  ...
                  <div class="one wide field">
                    <label>Sim</label>
                    <input name="pa_seguro_patrimonial" type="radio" value="1">
                  </div>
                  <div class="one wide field">
                    <label>Não</label>
                    <input name="pa_seguro_patrimonial" type="radio" checked="checked" value="0">
                  </div>
                  <div class="six wide field">
                  ...
                  <div class="one wide field">
                    <label>Sim</label>
                    <input name="pa_alvara" type="radio" value="1">
                  </div>
                  <div class="one wide field">
                    <label>Não</label>
                    <input name="pa_alvara" type="radio" checked="checked" value="0">
                  </div>
                </div>
                <div class="inline fields">
                  <div class="six wide field">
                  ...
                  <div class="one wide field">
                    <label>Sim</label>
                    <input name="pa_licenca_bombeiros" type="radio" value="1">
                  </div>
                  <div class="one wide field">
                    <label>Não</label>
                    <input name="pa_licenca_bombeiros" type="radio" checked="checked" value="0">
                  </div>
                  <div class="six wide field">
                  ...
                  <div class="one wide field">
                    <label>Sim</label>
                    <input name="pa_certificado_digital" type="radio" value="1">
                  </div>
                  <div class="one wide field">
                    <label>Não</label>
                    <input name="pa_certificado_digital" type="radio" checked="checked" value="0">
                  </div>
                </div>
              </div>
            </div>
