        ...
        <div class="ui segment"><!---->
            <div style="position: absolute;right: 20px;">
                <div class="ui breadcrumb"><a class="section" href="inicio"><i class="home icon"></i></a>
                    ...
                    <a class="section">Presbitérios</a>
                    <div class="divider">/</div>
                    <div class="active section">Incluir Reunião</div>
                </div>
            </div>
            <div class="ui clearing"></div>
            <h2 class="ui floated header">Reuniões do Presbitério
                <div class="sub header">Utilizado para apresentar o resultado de todos os relatórios do presbitério.
                </div>
            </h2>
            ...
            <div class="ui bottom attached tab segment" data-tab="second">
                <div class="ui segment">
                    <form id="cadastros_sinodos" name="cadastros_sinodos">
                        <div class="ui form">
                            <div class="fields">
                                <div class="two wide field disabled"><label>Ano</label> <input type="text" value="2018">
                                </div>
                                <div class="three wide field disabled"><label>Sínodo</label> <input type="text"
                                                                                                    value="Sinodo Norte Brasil">
                                </div>
                                <div class="six wide field disabled"><label>Presbitério</label> <input type="text"
                                                                                                       name="pr"
                                                                                                       value="Presbitério de Rondonia">
                                </div>
                                <div class="two wide field disabled"><label>Data da Reunião</label> <input type="text"
                                                                                                           value="25/02/2018">
                                </div>
                            </div>
                            <div class="ui clearing divider"></div>
                            <div style="text-align: center">
                                <button class="ui green labeled icon button" type="submit"><i class="plus icon"></i>Incluir
                                </button>
                                <button class="ui red right labeled icon button" type="button"><i
                ...
                <div class="ui red segment">
                    ...
                    <div class="ui bottom attached active tab segment" data-tab="first-reuniao"><p>Aqui são listadas as
                            igrejas cujos relatórios foram importados para serem contabilizados na reunião.</p>
                        <table class="ui compact selectable celled green unstackable table">
                            <thead>
                            <tr>
                                <th class="one wide">Código</th>
                    ...
                    <div class="ui bottom attached tab segment" data-tab="second-reuniao"><p>Nesta aba são listadas as
                            igrejas e seus relatórios para que seja possivel a importação para a reunião.</p>
                        ...
                        <div class="ui bottom attached tab segment" data-tab="second-igrejas">
                            <table class="ui compact selectable celled teal unstackable table">
                                <thead>
                                <tr>
                                    <th>Tipo</th>
                                    <th class="three wide">Inclusão</th>
                                    <th class="three wide">Ultima Alteração</th>
                                    <th class="center aligned">Importado</th>
                                </tr>
                                </thead>
                                <tbody>
                                <tr>
                                ...
                                <tr>
                                    <td>RELATÓRIO DO MINISTRO</td>
                                    <td>05/06/2018</td>
                                    <td>08/07/2018</td>
                                    <td class="center aligned"><i class="large red minus icon"></i></td>
                                </tr>
                                <tr>
                                    <td>RELATÓRIO DE ESTATÍSTICAS</td>
                                    <td>05/06/2018</td>
                                    <td>08/07/2018</td>
                                    <td class="center aligned"><i class="large green check icon"></i></td>
                                </tr>
                                ...
                                <th colspan="4">
                                    <div class="ui right floated small primary labeled icon button"><i
                                                class="plus icon"></i>Importar
                                    </div>
                                </th>
                                </tfoot>
                            </table>
...
<script src="js/app/reuniao-presbiterio-app.js"></script>
</body>
</html>