        ...
        <div class="ui segment">
          ...
          <div style="position: absolute;right: 20px;">
            <div class="ui breadcrumb"><a class="section" href="inicio"><i class="home icon"></i></a>
              <div class="divider">/</div><a class="section">Presbitérios</a>
          ...
          <h2 class="ui floated header">Reuniões do Presbitério
            <div class="sub header">Utilizado para apresentar o resultado de todos os relatórios do presbitério.</div>
          </h2>
          <div class="ui clearing divider"></div>
          <p></p>
          <div class="ui top attached tabular menu"><a class="item active" data-tab="first">Lista</a><a class="item" data-tab="second">Cadastrar</a></div>
          ...
          <div class="ui bottom attached tab segment" data-tab="second">
              ...
              <form id="cadastros_sinodos" name="cadastros_sinodos">
                <div class="ui form">
                  ...
                  <div style="text-align: center">
                    <button class="ui green labeled icon button" type="submit"><i class="plus icon"></i>Incluir</button>
            ...
            <div class="ui red segment">
              <div class="ui top attached tabular menu"><a class="active item" data-tab="first-reuniao">Lista</a><a class="item" data-tab="second-reuniao">Incluir</a></div>
              <div class="ui bottom attached active tab segment" data-tab="first-reuniao">
                <p>Aqui são listadas as igrejas cujos relatórios foram importados para serem contabilizados na reunião.</p>
                <table class="ui compact selectable celled green unstackable table">
                  <thead>
                    <tr>
                      <th class="one wide">Código</th>
              ...
              <div class="ui bottom attached tab segment" data-tab="second-reuniao">
                <p>Nesta aba são listadas as igrejas e seus relatórios para que seja possivel a importação para a reunião.</p>
                <div class="ui top attached tabular menu"><a class="active item" data-tab="first-igrejas">Igrejas</a><a class="item" data-tab="second-igrejas">Relatórios</a></div>
                ...
                <div class="ui bottom attached tab segment" data-tab="second-igrejas">
                  <table class="ui compact selectable celled teal unstackable table">
                    ...
                    <tfoot class="full-width">
                      <th colspan="4">
                        <div class="ui right floated small primary labeled icon button"><i class="plus icon"></i>Importar</div>
                      </th>
                    </tfoot>
                  </table>
                </div>
