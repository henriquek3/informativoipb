...
<main class="pusher"><!-- Header Mobile-->
    ...
    <div class="ui container" style="margin-top: 100px; margin-bottom: 20px; display:none;" id="windows">
        <div class="ui segment"><!---->
            ...
            <p></p>
            <div class="ui top attached tabular menu"><a class="item active" data-tab="first">Sínodos</a><a class="item"
            ...
            <div class="ui bottom attached tab segment" data-tab="second">
                <form id="cadastros_sinodos" name="cadastros_sinodos">@csrf
                    <div class="ui form">
                        <div class="fields">
                            <div class="eight wide required field"><label>Nome</label> <input type="text" name="nome"
                                                                                              placeholder="Digite o Nome">
                            </div>
                            <div class="three wide required field"><label>Sigla</label> <input type="text" name="sigla"
                                                                                               placeholder="Digite a Sigla">
                            </div>
                            <div class="six wide required field"><label>Região</label> <select
                                        class="ui search dropdown" name="regiao">
