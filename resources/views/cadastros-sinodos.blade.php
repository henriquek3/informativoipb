...
<html lang="pt-BR">
  ...
  <body>
        ...
        <div class="ui segment">
          ...
          <div style="position: absolute;right: 20px;">
            <div class="ui breadcrumb"><a class="section" href="inicio"><i class="home icon"></i></a>
              ...
              <div class="active section">Sínodos</div>
            </div>
          </div>
          <div class="ui clearing"></div>
          <h2 class="ui floated header">Cadastro de Sínodos
            <div class="sub header">Sínodos são usados para agrupar presbitérios. -> breve explicação da tela</div>
          </h2>
          <div class="ui clearing divider"></div>
          <p></p>
          <div class="ui top attached tabular menu"><a class="item active" data-tab="first">Sínodos</a><a class="item" data-tab="second">Cadastrar</a></div>
          <div class="ui bottom attached tab segment active" data-tab="first">
            <table class="ui compact selectable celled green unstackable table" id="tbl_sinodos">
              <thead>
                <tr>
              ...
              <tbody id="tbody_sinodos"></tbody>
            </table>
          </div>
          <div class="ui bottom attached tab segment" data-tab="second">
            <form id="cadastros_sinodos" name="cadastros_sinodos">@csrf
              <div class="ui form">
                <div class="fields">
              ...
              <div class="ui segments">
                <div class="ui horizontal segments">
                  <div class="ui segment"><span style="color: lightslategray;"><strong>Usuário:</strong></span><span style="color: lightslategray;">&nbsp;<span id="user_inc"></span>&nbsp;</span><span style="float: right;color: lightslategray;"><strong>Data:</strong>&nbsp;<span id="data_inc"></span></span></div>
                  <!--div.ui.segment
    ...
    <script src="js/app/cadastros-sinodos-app.js"></script>
  </body>
</html>