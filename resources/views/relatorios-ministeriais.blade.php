    ...
    <main class="pusher">
      ...
      <div class="ui container" style="margin-top: 100px; margin-bottom: 20px; display:none;" id="windows">
        <div class="ui segment">
          ...
          <p></p>
          <div class="ui top attached tabular menu"><a class="item active" data-tab="first">Relatórios</a><a class="item" data-tab="second">Responder</a></div>
          ...
          <form class="ui bottom attached tab segment" data-tab="second" id="relatorios_ministeriais" name="relatorios_ministeriais">@csrf
              ...
              <div class="ui form segment">
                ...
                <div class="fields">
                  <div class="ui calendar bottom left three wide field">
                    ...
                    <input class="datepicker2" type="text" value="0" name="nascimento_data" placeholder="Data de Nascimento" disabled="">
                  </div>
                ...
                <div class="fields">
                  ...
                  <div class="ui calendar bottom left four wide field">
                    <label>Data de Nascimento</label>
                    <input class="datepicker2" type="text" value="0" name="conjuge_nascimento" placeholder="Data de Nascimento do Cônjuge" disabled="">
                  </div>
                  <div class="two wide field">
                ...
                <div class="fields">
                  <div class="sixteen wide field">
                    ...
                    <input type="text" name="nome_filhos" placeholder="Nome dos Dependentes. OSB. use ; para separar os nomes" disabled="">
                  </div>
                </div>
                <div class="fields">
                  <div class="six wide field">
                  ...
                  <div class="four wide field">
                    ...
                    <input type="text" value="0" name="endereco_complemento" placeholder="Complemento" disabled="">
                  </div>
                  <div class="four wide field">
                    <label>Bairro</label>
                ...
                <div class="fields">
                  ...
                  <div class="eight wide field" data-tooltip="Digite ou Selecione o Presbitério onde foi ordenado.">
                    <label>Presbitério</label>
            ...
            <div class="ui segments">
              ...
              <div class="ui form segment">
                <div class="ui green ribbon label" style="font-size:0.92857143em;">1. DOUTRINAÇÃO</div><strong style="color:green;">No campo e fora do campo</strong>
              </div>
              <div class="ui form segment">
                <div class="fields">
                  <div class="four wide field">
              ...
              <div class="ui form segment">
                <div class="ui green ribbon label" style="font-size:0.92857143em;">2. ATOS PASTORAIS</div><strong style="color:green;">No campo e fora do campo</strong>
              </div>
              <div class="ui form segment">
                <div class="fields">
                  <div class="five wide field">
              ...
              <div class="ui form segment">
                <div class="ui green ribbon label" style="font-size:0.92857143em;">3. ASSISTÊNCIA PASTORAL</div><strong style="color:green;">No campo e fora do campo</strong>
              </div>
              <div class="ui form segment">
                <div class="fields">
                  <div class="four wide field">
              ...
              <div class="ui form segment">
                <div class="ui green ribbon label" style="font-size:0.92857143em;">3. ASSISTÊNCIA PASTORAL</div><strong style="color:green;">VISITAS</strong>
              </div>
              <div class="ui form segment">
                <div class="fields">
                  <div class="seven wide field">
                    <label>Evangélicos ou não:(considerar as visitas feitas nos lares como uma visita.)</label>
              ...
              <div class="ui form segment">
                <div class="ui green ribbon label" style="font-size:0.92857143em;">4. MINISTÉRIO DESIGNADO NOS TERMOS DO ARTIGO 37 DA CI/IPB</div>
              </div>
              <div class="ui form segment">
                <div class="fields">
                  <div class="sixteen wide field">
            ...
            <div class="ui segments">
              ...
              <div class="ui form segment">
                <div class="ui green ribbon label" style="font-size:0.92857143em;">1. CONCÍLIOS DA IPB</div><strong style="color:green;">No campo e fora do campo</strong>
              </div>
              <div class="ui form segment">
                <div class="fields">
                  <div class="four wide field">
              ...
              <div class="ui form segment">
                <div class="ui green ribbon label" style="font-size:0.92857143em;">2. CARGOS EM COMISSÕES EXECUTIVAS DOS CONCÍLIOS, SECRETARIAS DE CAUSAS, JUNTAS, COMISSÕES E AUTARQUIAS</div>
              </div>
              <div class="ui form segment">
                <div class="fields">
                  <div class="sixteen wide field">
                    <div class="ui tiny message">
                      <label>OBS. mencionar as funções exercidas nos diversos níveis conciliares da IPB e o número de reuniões durante o ano.</label>
                    </div>
                  </div>
                </div>
                <div class="fields">
              ...
              <div class="ui form segment">
                <div class="fields">
                  <div class="sixteen wide field">
                    <div class="ui tiny message">
                      <label>
                        OBS. Mencionar, estatisticamente, realizações no ano não previstas nos campos precedentes, dadas ou recebidas (cursos, leituras, encontros de estudos, congressos, etc.), bem como outras atividadesparalelas ao ministério pastoral (ex.: advocacia, jornalismo, magistério, etc.).</label>
                    </div>
                  </div>
                </div>
                <div class="fields">
