        ...
        <div class="ui segment">
            ...
            <div class="ui bottom attached tab segment active" data-tab="first">
                <table class="ui compact selectable celled green table" id="tbl_relatorios_ministeriais">
                    ...
                    <tbody id="tbody_relatorios_ministeriais">
                    <tr>
                        <td>01</td>
                        <td>RELATÓRIO MINISTERIAL</td>
                        <td>01/02/2017</td>
                        <td>20/02/2017</td>
                        <td>Em Edição</td>
                        <td>2018</td>
            ...
            <form class="ui bottom attached tab segment" data-tab="second" id="relatorios_ministeriais"
                  name="relatorios_ministeriais">
                <div class="ui segments">
                    <div class="ui green segment" style="text-align: center; background-color: #F9FAFB"><p><strong>Relatório
                                do Ministro Presbiteriano</strong></p></div>
                ...
                <div class="ui segments">
                    <div class="ui green segment" style="text-align: center; background-color: #F9FAFB"><p><strong>I -
                                Identificação do Ministro</strong></p></div>
                    <div class="ui form segment">
                        <div class="fields">
                        ...
                        <div class="fields">
                            <div class="ui calendar bottom left three wide field"><label>Data de Nascimento</label>
                                <input class="datepicker2" type="text" value="0" name="nascimento_data"
                                       placeholder="Data de Nascimento" disabled=""></div>
                            <div class="five wide field"><label>Estado Natal</label> <select
                            ...
                            <div class="eight wide field"><label>Cidade Natal</label> <select
                                        class="ui fluid search dropdown" disabled="">
                                    <option></option>
                        ...
                        <div class="fields">
                            <div class="four wide field"><label>RG</label> <input type="text" name="rg" placeholder="RG"
                                                                                  disabled=""></div>
                        ...
                        <div class="fields">
                            ...
                            <div class="ui calendar bottom left four wide field"><label>Data de Nascimento</label>
                                <input class="datepicker2" type="text" value="0" name="conjuge_nascimento"
                                       placeholder="Data de Nascimento do Cônjuge" disabled=""></div>
                        ...
                        <div class="fields">
                            <div class="six wide field"><label>Endereço</label> <input type="text" value="0"
                                                                                       name="endereco"
                                                                                       placeholder="Endereço"
                                                                                       disabled=""></div>
                            <div class="two wide field"><label>Número</label> <input type="text" value="0"
                                                                                     name="endereco_nr"
                                                                                     placeholder="Número" disabled="">
                            </div>
                            <div class="four wide field"><label>Complemento</label> <input type="text" value="0"
                                                                                           name="endereco_complemento"
                                                                                           placeholder="Complemento"
                                                                                           disabled=""></div>
                            <div class="four wide field"><label>Bairro</label> <input type="text" value="0"
                        ...
                        <div class="fields">
                            ...
                            <div class="five wide field"><label>Cidade</label> <select class="ui fluid search dropdown"
                                                                                       disabled="">
                                    <option></option>
                                    <option>Cidade</option>
                                    <option>Cidade</option>
                        ...
                        <div class="fields">
                            <div class="five wide field"><label>Condições de Moradia:</label> <select
                                        class="ui fluid search dropdown" name="condicao_moradia">
                                    <option value=""></option>
                            ...
                            <div class="three wide field"><label>Data de Ordenação:</label> <input type="text" value="0"
                                                                                                   name="ordenacao_data">
                            </div>
                            <div class="eight wide field"
                                 data-tooltip="Digite ou Selecione o Presbitério onde foi ordenado.">
                                <label>Presbitério</label> <select class="ui fluid search dropdown"
                                                                   name="id_presbiterio">
                                    <option></option>
                        ...
                        <div class="fields">
                            <div class="three wide field"><label>Dedicação ao Ministério:</label> <select
                                        class="ui fluid search dropdown" name="dedicacao_ministerio">
                                    <option value="0"></option>
                                    <option value="1">Integral</option>
                                    <option value="2">Parcial</option>
                                </select></div>
                            <div class="three wide field"><label>Férias</label> <select class="ui fluid search dropdown"
                                                                                        name="ferias">
                                    <option value="0"></option>
                            ...
                            <div class="five wide field"><label>Côngruas</label>
                                <div class="ui labeled input">
                                    <div class="ui label">R$</div>
                                    <input type="text" value="0" name="congruas"></div>
                            </div>
                        </div>
                        <div class="fields inline">
                            <div class="three wide field" data-tooltip="Possui aposentadoria pública?"><label>Aposentadoria
                                    pública?</label></div>
                            <div class="three wide field">
                                <div class="ui radio checkbox"><input name="previdencia_publica" type="radio"> <label>Sim</label>
                                </div>
                                <div class="ui radio checkbox"><input name="previdencia_publica" type="radio"
                                                                      checked="checked"> <label>Não</label></div>
                            </div>
                            <div class="three wide field" data-tooltip="Possui aposentadoria privada?"><label>Aposentadoria
                                    privada?</label></div>
                            <div class="three wide field">
                                <div class="ui radio checkbox"><input name="previdencia_privada" type="radio"> <label>Sim</label>
                                </div>
                                <div class="ui radio checkbox"><input name="previdencia_privada" type="radio"
                                                                      checked="checked"> <label>Não</label></div>
                            </div>
                            <div class="two wide field" data-tooltip="Possui plano de saúde?"><label>Plano de
                                    saúde?</label></div>
                            <div class="two wide field">
                                <div class="ui radio checkbox"><input name="plano_saude" type="radio">
                                    <label>Sim</label></div>
                                <div class="ui radio checkbox"><input name="plano_saude" type="radio" checked="checked">
                                    <label>Não</label></div>
                            </div>
                        </div>
                        <div class="fields inline">
                            <div class="five wide field"><label>Contribui para o INSS sobre o valor das
                                    Côngruas??</label></div>
                            <div class="two wide field">
                                <div class="ui radio checkbox"><input name="congruas_contribui_inss" type="radio">
                                    <label>Sim</label></div>
                                <div class="ui radio checkbox"><input name="congruas_contribui_inss" type="radio"
                                                                      checked="checked"> <label>Não</label></div>
                            </div>
                            <div class="five wide field" data-tooltip="Qual o valor da contribuição para o INSS?">
                                ...
                                <div class="ui labeled input">
                                    <div class="ui label">R$</div>
                                    <input type="text" name="previdencia_publica_valor" value="0"></div>
                            </div>
                            <div class="two wide field" data-tooltip="Contribui para Previdência Privada?"><label>Previdência
                                    Privada?</label></div>
                            <div class="two wide field">
                                <div class="ui radio checkbox"><input name="contribui_prev_privada" type="radio">
                                    <label>Sim</label></div>
                                <div class="ui radio checkbox"><input name="contribui_prev_privada" type="radio"
                                                                      checked="checked"> <label>Não</label></div>
                            </div>
                ...
                <div class="ui segments">
                    <div class="ui green segment" style="text-align: center; background-color: #F9FAFB"><p><strong>II -
                                Campo de Trabalho</strong></p></div>
                    <div class="ui form segment">
                        <div class="fields">
                            <div class="eight wide field"><label>Igreja(s):</label> <textarea rows="2" value="0"
                                                                                              name="ct_igreja"></textarea>
                            </div>
                            <div class="eight wide field"><label>Congregação(ões):</label> <textarea rows="2" value="0"
                                                                                                     name="ct_congregacoes"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="ui segments">
                    <div class="ui green segment" style="text-align: center; background-color: #F9FAFB"><p><strong>III -
                                Atuação Ministerial</strong></p></div>
                    <div class="ui form segment">
                        <div class="ui green ribbon label" style="font-size:0.92857143em;">1. DOUTRINAÇÃO</div>
                        <strong style="color:green;">No campo e fora do campo</strong></div>
                    <div class="ui form segment">
                        <div class="fields">
                            <div class="four wide field"><label>Pregações</label> <input type="text" value="0"
                                                                                         name="pregacoes"></div>
                            <div class="four wide field"><label>Aulas de Escola Dominical:</label> <input type="text"
                                                                                                          value="0"
                                                                                                          name="ebd">
                            </div>
                            <div class="four wide field"><label>Trabalhos de Evangelização:</label> <input type="text"
                                                                                                           value="0"
                                                                                                           name="evangelizacao">
                            </div>
                            <div class="four wide field"><label>Estudos Bíblicos:</label> <input type="text" value="0"
                                                                                                 name="estudos_biblicos">
                            </div>
                        </div>
                        <div class="fields">
                            <div class="four wide field"><label>Palestras, preleções especiais:</label> <input
                                        type="text" value="0" name="palestras_prelecoes"></div>
                            <div class="four wide field"><label>Mensagens - Rádio/TV:</label> <input type="text"
                                                                                                     value="0"
                                                                                                     name="msg_radio">
                            </div>
                            <div class="four wide field"><label>Artigos-jornais, boletins, revistas:</label> <input
                                        type="text" value="0" name="artigos_boletins_revistas"></div>
                            <div class="four wide field"><label>Entrevistas:</label> <input type="text" value="0"
                                                                                            name="entrevistas"></div>
                        </div>
                    </div>
                    <div class="ui form segment">
                    ...
                    <div class="ui form segment">
                        <div class="fields">
                            <div class="five wide field"><label>Santas Ceias:</label> <input type="text" value="0"
                                                                                             name="santa_ceia"></div>
                            <div class="six wide field"><label>Bênçãos Nupciais (com ou sem efeito civil):</label>
                                <input type="text" value="0" name="bencaos_nupciais"></div>
                            <div class="five wide field"><label>Funerais:</label> <input type="text" value="0"
                                                                                         name="funerais"></div>
                        </div>
                        <div class="fields">
                            <div class="five wide field"><label>Batismos Infantis:</label> <input type="text" value="0"
                                                                                                  name="batismos"></div>
                            <div class="six wide field"><label>Profissões de Fé:</label> <input type="text" value="0"
                                                                                                name="profissoes_fe">
                            </div>
                            <div class="five wide field"><label>Profissões de Fé & Batismos:</label> <input type="text"
                                                                                                            value="0"
                    ...
                    <div class="ui form segment">
                        <div class="fields">
                            <div class="four wide field"><label>Aconselhamentos/Orientações:</label> <input type="text"
                                                                                                            value="0"
                                                                                                            name="aconselhamentos">
                            </div>
                        </div>
                    </div>
                    <div class="ui form segment">
                        <div class="ui green ribbon label" style="font-size:0.92857143em;">3. ASSISTÊNCIA PASTORAL</div>
                        <strong style="color:green;">VISITAS</strong></div>
                    <div class="ui form segment">
                        <div class="fields">
                            <div class="seven wide field"><label>Evangélicos ou não:(considerar as visitas feitas nos
                                    lares como uma visita.)</label> <input type="text" value="0" name="visitas_lares">
                            </div>
                            <div class="six wide field"><label>Pontos de Pregação, Congregações ou Campos
                                    Missionários</label> <input type="text" value="0" name="visitas_igrejas"></div>
                            <div class="three wide field"><label>Departamentos Internos</label> <input type="text"
                                                                                                       value="0"
                    ...
                    <div class="ui form segment">
                        <div class="fields">
                            <div class="sixteen wide field"><label>Descrição das atividades:</label> <textarea rows="5"
                                                                                                               value="0"
                                                                                                               name="descricao_atividades"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="ui segments">
                    <div class="ui green segment" style="text-align: center; background-color: #F9FAFB"><p><strong>IV -
                                Atuação Conciliar</strong></p></div>
                    <div class="ui form segment">
                        <div class="ui green ribbon label" style="font-size:0.92857143em;">1. CONCÍLIOS DA IPB</div>
                        <strong style="color:green;">No campo e fora do campo</strong></div>
                    <div class="ui form segment">
                        <div class="fields">
                            <div class="four wide field"><label>Reuniões do Conselho:</label> <input type="text"
                                                                                                     value="0"
                                                                                                     name="reunioes_conselho">
                            </div>
                            <div class="four wide field"><label>Assembleias Gerais da Igreja:</label> <input type="text"
                                                                                                             value="0"
                                                                                                             name="assembleias">
                            </div>
                            <div class="four wide field"><label>Diáconos Ordenados e/ou Investidos:</label> <input
                                        type="text" value="0" name="diaconos_ordenados_investidos"></div>
                            <div class="four wide field"><label>Presbíteros Ordenados e/ou Investidos:</label> <input
                                        type="text" value="0" name="presbiteros_ordenados_investidos"></div>
                        </div>
                        <div class="fields">
                            <div class="three wide field"><label>Reuniões do Presbitério:</label> <input type="text"
                                                                                                         value="0"
                                                                                                         name="reunioes_presbiterio">
                            </div>
                            <div class="three wide field"><label>Reuniões do Sínodo:</label> <input type="text"
                                                                                                    value="0"
                                                                                                    name="reunioes_sinodo">
                            </div>
                            <div class="four wide field"><label>Reuniões do Supremo Concílio da IPB:</label> <input
                                        type="text" value="0" name="reunioes_concilio"></div>
                        </div>
                        <div class="fields">
                            <div class="sixteen wide field"><label>Comentários:</label> <textarea rows="3" value="0"
                    ...
                    <div class="ui form segment">
                        <div class="fields">
                            <div class="sixteen wide field">
                                <div class="ui tiny message"><label>OBS. mencionar as funções exercidas nos diversos
                                        níveis conciliares da IPB e o número de reuniões durante o ano.</label></div>
                            </div>
                        </div>
                        <div class="fields">
                            <div class="sixteen wide field"><label>No Presbitério:</label> <textarea rows="3" value="0"
                                                                                                     name="cargos_presbiterio"></textarea>
                            </div>
                        </div>
                        <div class="fields">
                            <div class="sixteen wide field"><label>No Sínodo:</label> <textarea rows="3" value="0"
                                                                                                name="cargos_sinodo"></textarea>
                            </div>
                        </div>
                        <div class="fields">
                            <div class="sixteen wide field"><label>No Supremo Concílio:</label> <textarea rows="3"
                                                                                                          value="0"
                                                                                                          name="cargos_concilio"></textarea>
                            </div>
                        </div>
                        <div class="fields">
                            <div class="sixteen wide field"><label>Em Juntas, Comissões e Autarquias da IPB:</label>
                                <textarea rows="3" value="0" name="cargos_outros"></textarea></div>
                        </div>
                        <div class="fields">
                            <div class="sixteen wide field"><label>Texto complementar::</label> <textarea rows="4"
                                                                                                          name="texto_complementar"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="ui segments">
                    <div class="ui green segment" style="text-align: center; background-color: #F9FAFB"><p><strong>V.
                                Outras Atividades</strong></p></div>
                    <div class="ui form segment">
                        <div class="fields">
                            <div class="sixteen wide field">
                                <div class="ui tiny message"><label>OBS. Mencionar, estatisticamente, realizações no ano
                                        não previstas nos campos precedentes, dadas ou recebidas (cursos, leituras,
                                        encontros de estudos, congressos, etc.), bem como outras atividadesparalelas ao
                                        ministério pastoral (ex.: advocacia, jornalismo, magistério, etc.).</label>
                                </div>
                            </div>
                        </div>
                        <div class="fields">
                            <div class="sixteen wide field"><label>1. Atualização e Aperfeiçoamento:</label> <textarea
                                        rows="3" value="0" name="atualizacao_aperfeicoamento"></textarea></div>
                        </div>
                        <div class="fields">
                            <div class="sixteen wide field"><label>2. Atividades em entidades
                                    para-eclesiásticas:</label> <textarea rows="3" value="0"
                                                                          name="atividades_para_eclesiasticas"></textarea>
                            </div>
                        </div>
                        <div class="fields">
                            <div class="sixteen wide field"><label>3. Atividades Extra Ministeriais:</label> <textarea
                                        rows="3" value="0" name="atividades_extras_ministeriais"></textarea></div>
                        </div>
                        <div class="fields">
                            <div class="sixteen wide field"><label>Outras</label> <textarea rows="3" value="0"
                                                                                            name="atividades_outros"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
