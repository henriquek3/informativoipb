          ...
          <form class="ui bottom attached tab segment" data-tab="second" id="relatorios_estatisticas">@csrf
              ...
              <div class="ui form segment">
                <div class="ui horizontal segments">
                  <div class="ui segment" style="width: 30%;">
                    <div class="ui top attached label blue" style="text-align: center;">LIDERANÇA FORMAL</div>
                  ...
                  <div class="ui segment" style="width: 30%;">
                    <div class="ui top attached label blue" style="text-align: center;">ESTRUTURA DO TRABALHO</div>
                    <div class="inline fields">
                  ...
                  <div class="ui segment" style="width: 40%;">
                    <div class="ui top attached label blue" style="text-align: center;">DEPARTAMENTOS INTERNO</div>
                    <div class="inline fields">
                      <div class="four wide field">
                        <label>UCP</label>
                      </div>
            ...
            <div class="ui segments">
              ...
              <div class="ui form segment">
                <div class="ui horizontal segments">
                  <div class="ui segment">
                    <div class="ui top attached label blue" style="text-align: center;">ADMISSÃO - COMUNGANTES</div>
                    <div class="inline fields">
                      <div class="five wide field">
                  ...
                  <div class="ui segment">
                    <div class="ui top attached label blue" style="text-align: center;">ADMISSÃO - NÃO-COMUNGANTES</div>
                    <div class="inline fields">
                      <div class="five wide field">
                        <label>Batismo</label>
                      </div>
                ...
                <div class="ui horizontal segments">
                  <div class="ui segment">
                    <div class="ui top attached label blue" style="text-align: center;">DEMISSÃO - COMUNGANTES</div>
                    <div class="inline fields">
                      <div class="five wide field">
                        <label>Transferência</label>
                      </div>
                  ...
                  <div class="ui segment">
                    <div class="ui top attached label blue" style="text-align: center;">DEMISSÃO - NÃO-COMUNGANTES</div>
                    <div class="inline fields">
                      <div class="five wide field">
                        <label>Profissão de Fé</label>
                      </div>
                ...
                <div class="ui horizontal segments">
                  ...
                  <div class="ui segment">
                    ...
                    <div class="inline fields">
                      <div class="five wide field" data-tooltip="RESULTADO (Comungantes + Não Comungantes)">
            ...
            <div class="ui segments">
              ...
              <div class="ui form segment">
                <div class="ui horizontal segments">
                  <div class="ui segment">
                    <div class="ui top attached label blue" style="text-align: center;">MOVIMENTO FINANCEIRO - ANO ANTERIOR</div>
                    <div class="inline fields">
                      <div class="eight wide field">
                  ...
                  <div class="ui segment">
                    <div class="ui top attached label blue" style="text-align: center;">PREVISÃO ORÇAMENTÁRIA - PRÓXIMO EXERCÍCIO</div>
                    <div class="inline fields">
                      <div class="eight wide field">
                        <label>Saldo - Ano Anterior</label>
                      </div>
