...
<main class="pusher"><!-- Header Mobile-->
    ...
    <div class="ui container" style="margin-top: 100px; margin-bottom: 20px; display:none;" id="windows">
        <div class="ui segment">
            ...
            <h2 class="ui floated header">Consultar Estatísticas do Presbitério
                <div class="sub header">Consulta a estatística unificada das igrejas do presbitério. -> breve explicação
                    da tela
                </div>
            </h2>
            ...
            <div class="ui bottom attached tab segment active" data-tab="first">
                <div class="ui segments">
                    <div class="ui teal segment" style="text-align: center; background-color: #F9FAFB"><p></p>
                        <div class="ui header"><strong>CONSULTA UNIFICADA DOS RELATÓRIOS DAS IGREJAS DO
                                PRESBITÉRIO</strong></div>
                        <p></p>
                        <table class="ui compact selectable celled striped table">
                            ...
                            <tbody>
                            <tr>
                                <td><label>Pastores</label></td>
                                <td><label>0</label></td>
                            </tr>
                            <tr>
                                <td><label>Licenciados</label></td>
                                <td><label>0</label></td>
                            </tr>
                            <tr>
                                <td><label>Presbíteros</label></td>
                                <td><label>0</label></td>
                            </tr>
                            <tr>
                                <td><label>Diáconos</label></td>
                                <td><label>0</label></td>
                            </tr>
                            <tr>
                                <td><label>Evangelistas</label></td>
                                <td><label>0</label></td>
                            </tr>
                            <tr>
                                <td><label>Missionários</label></td>
                                <td><label>0</label></td>
                            </tr>
                            <tr>
                                <td><label>Candidatos</label></td>
                                <td><label>0</label></td>
                            </tr>
                            <tr>
                                <td><label>Igrejas</label></td>
                                <td><label>0</label></td>
                            </tr>
                            <tr>
                                <td><label>Congreg. de Igrejas</label></td>
                                <td><label>0</label></td>
                            </tr>
                            <tr>
                                <td><label>Pontos de Pregação</label></td>
                                <td><label>0</label></td>
                            </tr>
                            <tr>
                                <td><label>N.º Escolas Dom.</label></td>
                                <td><label>0</label></td>
                            </tr>
                            <tr>
                                <td><label>N.º Prof. da ED</label></td>
                                <td><label>0</label></td>
                            </tr>
                            <tr>
                                <td><label>N.º Alunos ED - Anterior</label></td>
                                <td><label>0</label></td>
                            </tr>
                            <tr>
                                <td><label>N.º Alunos ED - Atual.</label></td>
                                <td><label>0</label></td>
                            </tr>
                            <tr>
                                <td><label>Variação Percentual</label></td>
                                <td><label>0</label></td>
                            </tr>
                            <tr>
                                <td><label>Congreg. Presbiteriais</label></td>
                                <td><label>0</label></td>
                            </tr>
                            <tr>
                                <td><label>N.º de Educandários</label></td>
                                <td><label>0</label></td>
                            </tr>
                            <tr>
                                <td><label>N.º de Alunos Educ.</label></td>
                                <td><label>0</label></td>
                            </tr>
                            <tr>
                                <td><label>N.º de Creches</label></td>
                                <td><label>0</label></td>
                            </tr>
                            <tr>
                                <td><label>N.º de Crianças</label></td>
                                <td><label>0</label></td>
                            </tr>
                            <tr>
                                <td><label>N.º Outros</label></td>
                                <td><label>0</label></td>
                            </tr>
                            <tr>
                                <td><label>N.º de Pessoas</label></td>
                                <td><label>0</label></td>
                            </tr>
                            <tr>
                                <td><label>N.º UCPs</label></td>
                                <td><label>0</label></td>
                            </tr>
                            <tr>
                                <td><label>Sócios UCP</label></td>
                                <td><label>0</label></td>
                            </tr>
                            <tr>
                                <td><label>N.º UPA</label></td>
                                <td><label>0</label></td>
                            </tr>
                            <tr>
                                <td><label>Sócios UPA</label></td>
                                <td><label>0</label></td>
                            </tr>
                            <tr>
                                <td><label>N.º UMP</label></td>
                                <td><label>0</label></td>
                            </tr>
                            <tr>
                                <td><label>Sócios UMP</label></td>
                                <td><label>0</label></td>
                            </tr>
                            <tr>
                                <td><label>N.º SAF</label></td>
                                <td><label>0</label></td>
                            </tr>
                            <tr>
                                <td><label>Sócias SAF</label></td>
                                <td><label>0</label></td>
                            </tr>
                            <tr>
                                <td><label>UPH</label></td>
                                <td><label>0</label></td>
                            </tr>
                            <tr>
                                <td><label>Sócios UPH</label></td>
                                <td><label>0</label></td>
                            </tr>
                            <tr>
                                <td><label>N.º Outros</label></td>
                            ...
                            <tr>
                                <td><label>Sócios Outros</label></td>
                                <td><label>0</label></td>
                            </tr>
                            <tr>
                                <td><label>Total de Sociedades</label></td>
                                <td><label>0</label></td>
                            </tr>
                            <tr>
                                <td><label>Total de Sócios</label></td>
                                <td><label>0</label></td>
                            </tr>
                            </tbody>
                        </table>
            ...
            <div class="ui bottom attached tab segment" data-tab="second">
                <div class="ui segments">
                    <div class="ui teal segment" style="text-align: center; background-color: #F9FAFB"><p></p>
                        <div class="ui header"><strong>CONSULTA UNIFICADA DOS RELATÓRIOS DA IGREJA DE CACOAL</strong>
                        </div>
                        <p></p>
                        <table class="ui compact selectable celled striped table">
                            <thead>
...
<script src="js/app/consultar-estatisticas-presbiterio-app.js"></script>
</body>
</html>