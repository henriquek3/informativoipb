      ...
      <div class="ui container" style="margin-top: 100px; margin-bottom: 20px; display:none;" id="windows">
        <div class="ui segment">
          ...
          <h2 class="ui floated header">Consultar Estatísticas do Presbitério
            <div class="sub header">Consulta a estatística unificada das igrejas do presbitério. -> breve explicação da tela</div>
          </h2>
          <div class="ui clearing divider"></div>
          <p></p>
          <div class="ui top attached tabular menu"><a class="item active" data-tab="first">Total Geral</a><a class="item" data-tab="second">IP Cacoal</a></div>
          <div class="ui bottom attached tab segment active" data-tab="first">
            <div class="ui segments">
              <div class="ui teal segment" style="text-align: center; background-color: #F9FAFB">
                <p>
                  <div class="ui header"><strong>CONSULTA UNIFICADA DOS RELATÓRIOS DAS IGREJAS DO PRESBITÉRIO</strong></div>
                </p>
                <table class="ui compact selectable celled striped table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>
                        <label>Congreg. de Igrejas</label>
                      </td>
                      <td>
                        <label>0</label>
                      </td>
                    ...
                    <tr>
                      <td>
                        <label>N.º Alunos ED - Anterior</label>
                      </td>
                      <td>
                        <label>0</label>
                      </td>
                    ...
                    <tr>
                      <td>
                        <label>N.º Alunos ED - Atual.</label>
                      </td>
                      <td>
                        <label>0</label>
                      </td>
                    ...
                    <tr>
                      <td>
                        <label>Congreg. Presbiteriais</label>
                      </td>
                      <td>
                        <label>0</label>
                      </td>
                    ...
                    <tr>
                      <td>
                        <label>N.º de Educandários</label>
                      </td>
                      <td>
                        <label>0</label>
                      </td>
                    ...
                    <tr>
                      <td>
                        <label>N.º de Alunos Educ.</label>
                      </td>
                      <td>
                        <label>0</label>
                      </td>
                    ...
                    <tr>
                      <td>
                        <label>Total  de Sociedades</label>
                      </td>
                      <td>
                        <label>0</label>
                      </td>
          ...
          <div class="ui bottom attached tab segment" data-tab="second">
            <div class="ui segments">
              <div class="ui teal segment" style="text-align: center; background-color: #F9FAFB">
                <p>
                  <div class="ui header"><strong>CONSULTA UNIFICADA DOS RELATÓRIOS DA IGREJA DE CACOAL</strong></div>
                </p>
                <table class="ui compact selectable celled striped table">
                  <thead>
                    <tr>
