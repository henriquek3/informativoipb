...
<main class="pusher"><!-- Header Mobile-->
    ...
    <div class="ui container" style="margin-top: 100px; margin-bottom: 20px; display:none;" id="windows">
        <div class="ui segment">
            ...
            <h2 class="ui floated header">Cadastro de Igrejas
                <div class="sub header">Igrejas pertencentes aos presbitério. - breve explicação da tela</div>
            </h2>
            <div class="ui clearing divider"></div>
            <p></p>
            <div class="ui top attached tabular menu"><a class="item active" data-tab="first">Lista</a><a class="item"
                                                                                                          data-tab="second">Cadastro</a><a
                        class="item" data-tab="third">Congregações</a></div>
            <div class="ui bottom attached tab segment active" data-tab="first">
                <table class="ui compact selectable celled green table" id="tbl_igrejas">
                    <thead>
                    <tr>
            ...
            <div class="ui bottom attached tab segment" data-tab="second">
                <form id="cadastros_igrejas" name="cadastros_igrejas">
                    <div class="ui form">
                            ...
                            <div class="four wide field">
                                <div class="clearfix">
                                    <div class="ui checkbox"
                                         style="float: left; display: flex; margin-top: 32px; margin-left: 20px;"><input
                                                type="checkbox"> <label>Congregação do Presbitério</label></div>
                                </div>
                            </div>
                        </div>
                        <div class="fields">
                            <div class="six wide field"><label>Estado</label> <select class="ui fluid search dropdown"
                                                                                      name="id_estado"></select></div>
                            <div class="six wide field" id="div_cidade"><label>Cidade</label> <select
                                        class="ui fluid search dropdown" name="id_cidade" id="id_cidade"></select>
                                <div class="ui active inline small loader" style="display:none"
                                     id="loader_cidade"></div>
                            </div>
                            <div class="four wide field"><label>CNPJ</label> <input type="text" name="cnpj"
                                                                                    placeholder="CNPJ"></div>
                        </div>
                        <div class="fields">
                            <div class="thirteen wide field"><label>Nome</label> <input type="text" name="nome"
                                                                                        placeholder="Digite o Nome">
                            </div>
                            <div class="ui calendar bottom left three wide field"><label>Organização</label>
                                <!--input.datepicker2(type="text" name="data_organizacao" placeholder="Data de Organização")-->
                                <input type="date" name="data_organizacao" placeholder="Data de Organização"></div>
                        </div>
                        <div class="fields">
                            <div class="six wide field"><label>Endereço</label> <input type="text" name="endereco"
                                                                                       placeholder="Endereço"></div>
                            <div class="two wide field"><label>Número</label> <input type="text" name="endereco_numero"
                        ...
                        <div class="fields">
                            <div class="eight wide field"><label>E-mail</label> <input type="email" name="email"
                                                                                       placeholder="E-Mail"></div>
                            <div class="eight wide field"><label>Homepage</label> <input type="url" name="homepage"
                                                                                         placeholder="Web Site"></div>
                        </div>
                    </div>
            ...
            <div class="ui bottom attached tab segment" data-tab="third">
                <div class="ui top attached tabular menu"><a class="item active" data-tab="first-cong">Lista</a><a
                            class="item" data-tab="second-cong">Cadastro</a></div>
                <div class="ui bottom attached tab segment active" data-tab="first-cong">
                    <table class="ui compact selectable celled blue table">
                        <thead>
                        <tr>
                            <th class="one wide">Código</th>
                            <th class="ten wide">Nome</th>
                        ...
                        <tr>
                            <td>01</td>
                            <td>Congregação luz e vida</td>
                            <td>Cidade Alta</td>
                        </tr>
                        </tbody>
                    </table>
                </div>
                <div class="ui bottom attached tab segment" data-tab="second-cong">
                    <form id="cadastros_congregacoes" name="cadastros_congregacoes">
                        <div class="ui form">
                            <div class="fields">
                                ...
                                <div class="eight wide field"><label>Estado</label> <select
                                ...
                                <div class="eight wide field"><label>Cidade</label> <select
                                            class="ui fluid search dropdown">
                                        <option></option>
                            ...
                            <div class="fields">
                                <div class="ten wide field"><label>Nome</label> <input type="text" name="nome"
                                                                                       placeholder="Digite seu Nome">
                                </div>
                                <div class="three wide field"><label>CNPJ</label> <input type="text" name="cnpj"
                                                                                         placeholder="CNPJ"></div>
                                <div class="ui calendar bottom left three wide field"><label>Organização</label> <input
                                            class="datepicker2" type="text" name="data_organizacao"
                                            placeholder="Data de Organização"></div>
                            </div>
                            <div class="fields">
                                <div class="six wide field"><label>Endereço</label> <input type="text" name="endereco"
                                                                                           placeholder="Endereço"></div>
                                ...
                                <div class="four wide field"><label>Bairro</label> <input type="text"
                            ...
                            <div class="fields">
                                <div class="eight wide field"><label>E-mail</label> <input type="email" name="email"
                                                                                           placeholder="E-Mail"></div>
                                <div class="eight wide field"><label>Homepage</label> <input type="url" name="website"
                        ...
                        <div class="ui segments">
                            <div class="ui horizontal segments">
                                <div class="ui segment"><span
                                            style="color: lightslategray;"><strong>Usuário inclusão:</strong></span><span
                                            style="color: lightslategray;">&nbsp;<span id="user_inc_congr"></span>&nbsp;</span><span
                                            style="float: right;color: lightslategray;"><strong>Data:</strong>&nbsp;<span
                                                id="data_inc_congr"></span></span></div>
                                <div class="ui segment"><span
                                            style="color: lightslategray;"><strong>Última alteração:</strong></span><span
                                            style="color: lightslategray;">&nbsp;<span id="user_alt_congr"></span>&nbsp;</span><span
                                            style="float: right;color: lightslategray;"><strong>Data:</strong>&nbsp;<span
                                                id="data_alt_congr"></span></span></div>
                            </div>
                        </div>
                        <div class="ui clearing divider"></div>
                        <div style="text-align: center">
...
<script src="js/app/cadastros-igrejas-app.js"></script>
</body>
</html>