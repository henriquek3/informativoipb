...
<html lang="pt-BR">
  ...
  <body>
    ...
    <main class="pusher">
      ...
      <div class="ui container" style="margin-top: 100px; margin-bottom: 20px; display:none;" id="windows">
        <div class="ui segment">
          ...
          <p></p>
          <div class="ui top attached tabular menu"><a class="item active" data-tab="first">Lista</a><a class="item" data-tab="second">Cadastro</a><a class="item" data-tab="third">Congregações</a></div>
          ...
          <div class="ui bottom attached tab segment" data-tab="second">
            <form id="cadastros_igrejas" name="cadastros_igrejas">@csrf
              <div class="ui form">
                <div class="fields">
                  ...
                  <div class="six wide field" id="div_presbiterio">
                    ...
                    <select class="ui fluid search dropdown" name="id_presbiterio" id="id_presbiterio"></select>
                    <div class="ui active inline small loader" style="display:none" id="loader_presbiterio"></div>
                  </div>
                  <div class="four wide field">
                    <div class="clearfix">
                      <div class="ui checkbox" style="float: left; display: flex; margin-top: 32px; margin-left: 20px;">
          ...
          <div class="ui bottom attached tab segment" data-tab="third">
            <div class="ui top attached tabular menu"><a class="item active" data-tab="first-cong">Lista</a><a class="item" data-tab="second-cong">Cadastro</a></div>
            <div class="ui bottom attached tab segment active" data-tab="first-cong">
              <table class="ui compact selectable celled blue table" id="tbl_congregacoes">
                <thead>
                  <tr>
                    <th class="one wide">Código</th>
                    <th class="ten wide">Nome</th>
                ...
                <tbody id="tbody_congregacoes"></tbody>
              </table>
            </div>
            <div class="ui bottom attached tab segment" data-tab="second-cong">
              <form id="cadastros_congregacoes" name="cadastros_congregacoes">@csrf
                <div class="ui form">
                  <div class="fields">
                    ...
                    <div class="eight wide field" id="div_cidade_congregacoes">
                      <label>Cidade</label>
                      <select class="ui fluid search dropdown" name="id_cidade" id="id_cidade_congregacoes"></select>
                      <div class="ui active inline small loader" style="display:none" id="loader_cidade_congregacoes"></div>
                    </div>
                  </div>
                  <div class="fields">
                    ...
                    <div class="three wide field">
                      <label>CNPJ</label>
                      <input type="text" name="cnpj" id="cnpj_congregacoes" placeholder="CNPJ">
                    </div>
                    <div class="ui calendar bottom left three wide field">
                      <label>Organização</label>
                      <!--input.datepicker2(type="date" name="data_organizacao" placeholder="Data de Organização")-->
                      <input type="date" name="data_organizacao" placeholder="Data de Organização">
                    </div>
                  </div>
                  <div class="fields">
                ...
                <div class="ui segments">
                  <div class="ui horizontal segments">
                    <div class="ui segment"><span style="color: lightslategray;"><strong>Usuário inclusão:</strong></span><span style="color: lightslategray;">&nbsp;<span id="user_inc_congr"></span>&nbsp;</span><span style="float: right;color: lightslategray;"><strong>Data:</strong>&nbsp;<span id="data_inc_congr"></span></span></div>
                    <div class="ui segment"><span style="color: lightslategray;"><strong>Última alteração:</strong></span><span style="color: lightslategray;">&nbsp;<span id="user_alt_congr"></span>&nbsp;</span><span style="float: right;color: lightslategray;"><strong>Data:</strong>&nbsp;<span id="data_alt_congr"></span></span></div>
                  </div>
                </div>
                <div class="ui clearing divider"></div>
                <div style="text-align: center">
    ...
    <script src="js/app/cadastros-congregacoes-app.js"></script>
